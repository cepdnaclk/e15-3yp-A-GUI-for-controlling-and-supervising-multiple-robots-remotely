...
void Robot_PCF8574::begin(uint8_t address) {
...
void Robot_PCF8574::pinMode(uint8_t pin, uint8_t mode) {
...
void Robot_PCF8574::digitalWrite(uint8_t pin, uint8_t value) {
...
uint8_t Robot_PCF8574::digitalRead(uint8_t pin) {
...
void Robot_PCF8574::write(uint8_t value) {
...
void Robot_PCF8574::blink(uint8_t pin, uint16_t count, uint32_t duration) {
...
#ifdef PCF8574_INTERRUPT_SUPPORT
void Robot_PCF8574::enableInterrupt(uint8_t pin, void (*selfCheckFunction)(void)) {
...
void Robot_PCF8574::disableInterrupt() {

	/* Detach interrupt handler */
	PCdetachInterrupt(_pcintPin);
}

void Robot_PCF8574::checkForInterrupt() {
...
void Robot_PCF8574::attachInterrupt(uint8_t pin, void (*userFunc)(void),
		uint8_t mode) {
...
void Robot_PCF8574::detachInterrupt(uint8_t pin) {
