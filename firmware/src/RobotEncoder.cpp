...
RobotEncoder *RobotEncoder::encoders[MAX_ESP32_ENCODERS] = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL};
...
void RobotEncoder::attach(int a) {
  if (attached) {
  ...
  if (RobotEncoder::attachedInterrupt == false) {
    ...
    esp_err_t er = pcnt_isr_register(pcnt_example_intr_handler, (void *) NULL, (int)0, (pcnt_isr_handle_t *)&RobotEncoder::user_isr_handle);
    if (er != ESP_OK) {
...
void RobotEncoder::attachCounter(int aPintNumber) {
  attach(aPintNumber);
}
