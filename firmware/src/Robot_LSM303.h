...
*/
template <typename T> float Robot_LSM303::heading(vector<T> from)
{
...
template <typename Ta, typename Tb, typename To> void Robot_LSM303::vector_cross(const vector<Ta> *a, const vector<Tb> *b, vector<To> *out)
{
...
template <typename Ta, typename Tb> float Robot_LSM303::vector_dot(const vector<Ta> *a, const vector<Tb> *b)
{
